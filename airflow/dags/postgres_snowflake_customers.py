...
with DAG(
    dag_id="ingest_bronze_postgres_snowflake_customers",
    description="Ingest customers table data from Postgres to Snowflake (Bronze)",
    ...
    with TaskGroup(group_id="airbyte_ingestion") as airbyte_ingestion:
        trigger_sync = AirbyteTriggerSyncOperator(
            ...
            connection_id="918dcdaf-4ad4-4b43-8efc-34008521e500",
            asynchronous=True,
        )
